    ...
    return (
      <div className='col-sm-12 col-md-12 col-lg-3 col-xs-12 formContainer c-add-form'>
        <div className='block full'>
            ...
            <form id='add-shebang' action='' method='post' className='form-horizontal form-bordered'>
              <div className='form-group'>
                <label className='col-md-3 control-label' htmlFor='new-shebang-name'>Add shebang form</label>
                <div className='col-md-9'>
                  <input type='text' id='new-shebang-name' name='new-shebang-name' rows='9'
                         className='form-control required'
                         placeholder='KFC...'/>
                </div>
                <label className='col-md-3 control-label' htmlFor='new-shebang-address'>Address</label>
                <div className='col-md-9'>
                  <input type='text' id='new-shebang-address' name='new-shebang-address' rows='9'
                         className='form-control required'
